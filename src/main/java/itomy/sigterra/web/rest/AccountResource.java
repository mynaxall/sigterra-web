...
import itomy.sigterra.domain.PersistentToken;
...
import itomy.sigterra.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    public ResponseEntity<String> saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getUsername(), userDTO.getAddress(), userDTO.getCompanyName(), userDTO.getCompanySite(), userDTO.getJobTitle(), userDTO.getPhoneNumber());
